...
function ChatWrapper({ fileId }: ChatWrapperProps) {
  ...
  if (isLoading) {
    return (
      <div className='relative min-h-full bg-zince-50 flex divide-y divide-zinc-200 flex-col justify-between'>
  ...
  return (
    <ChatContextProvider fileID={fileId}>
      <div className='relative min-h-full bg-zinc-50 flex divide-y divide-zinc-200 gap-2'>
